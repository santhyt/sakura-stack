...
def classify_section(text: str) -> str:
    ...
    if any(marker in text for marker in ["〜て", "〜に", "〜が", "〜は", "grammar", "pattern", "structure"]):
        return "grammar"
    
    # Vocabulary sections often have this structure
    if any(marker in text_lower for marker in ["vocabulary", "vocab", "meaning", "reading", "n3", "n4", "n5"]):
        return "vocabulary"
